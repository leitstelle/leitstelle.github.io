...
#
#
# GitLab 7.2-stable installation on uberspace account with rbenv.
# Using:
# Git 2.0.4
# Redis 2.8.13
# Python 2.7
...
DOMAINNAME="gitlab.zisko.industries"
...
toast arm https://www.kernel.org/pub/software/scm/git/git-2.1.0.tar.gz
...
# CMake.
toast arm http://www.cmake.org/files/v3.0/cmake-3.0.2.tar.gz
...
rbenv local 2.1.2
git fetch origin && git reset --hard $(git describe v1.9.7 || git describe origin/v1.9.7)
